const i18n = (function () {
  ...
  const STRINGS = {
    zh: {
      ...
      'index.shareDisabledPrivate': '不公開的 UID 無法產生分享文字',
    ...
    en: {
      ...
      'index.madePrivateSuccess': 'Set to private. UID: {uid} will not appear in the exchange market.',
      'index.madePublicSuccess': 'Set to public. UID: {uid} will appear in the exchange market.',
      'index.shareDisabledPrivate': 'Share text is unavailable for private UIDs',
    ...
    ja: {
      ...
      'index.shareDisabledPrivate': '非公開のUIDはシェア文を作成できません',
    ...
    ko: {
      ...
      'index.madePrivateSuccess': '비공개로 설정되었습니다. UID: {uid}는 교환 마켓에 표시되지 않습니다',
      'index.madePublicSuccess': '공개로 설정되었습니다. UID: {uid}는 교환 마켓에 표시됩니다',
      'index.shareDisabledPrivate': '비공개 UID는 공유 텍스트를 생성할 수 없습니다',
